...
public class Feature01_PartyRoom_Controller {
    ...
    public ResponseEntity<?> getPartyRoomDetails(@PathVariable int movieId) {
        ...
        movie.setImageUrl("http://localhost:8080/images/movie" + String.valueOf(movieId) + ".jpg");
        ...
        response.put("imageUrl", "http://localhost:8080/images/movie" + String.valueOf(movieId) + ".jpg"); // => frontend 구현 부분
